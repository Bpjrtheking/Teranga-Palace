...
function activerNavigation() {
    ...
    liens.forEach(lien => {
        lien.addEventListener("click", () => {
            ...
            // Sur mobile, on referme le menu déroulant après avoir choisi une section
            if (menu) menu.classList.remove("ouvert");
        });
    });
}

// Ouvre/ferme le menu déroulant mobile (bouton hamburger)
function activerMenuHamburger() {
